    ...
    switch (errorType) {
      case "auth":
        return {
          ...
          message:
            "It looks like your session has expired. Try reloading the page to sign in again.",
        };
      case "network":
        return {
          icon: "fas fa-wifi",
          ...
          message:
            "We're having trouble connecting to the server. You might want to check your internet connection and try again.",
        };
      case "server":
        return {
          icon: "fas fa-server",
      ...
      default:
        return {
          ...
          message:
            "Something went wrong. You can try reloading the page and see if that helps.",
        };
    }
  }
</script>
